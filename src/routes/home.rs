...
use crate::{
    config::{load_about_items, load_projects, load_site_profile},
...
async fn handler_home_page(
    ...
    if cfg!(debug_assertions) {
        ...
        res.headers_mut().insert(
            ...
            HeaderValue::from_str(&httpdate::fmt_http_date(state.started_at)).unwrap(),
        );
        return res;
    }
